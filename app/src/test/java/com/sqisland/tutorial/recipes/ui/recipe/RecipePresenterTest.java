...
public class RecipePresenterTest {
    ...
    public void recipeNotFound() {
        when(store.getRecipe(Mockito.anyString())).thenReturn(null);
    ...
    public void loadWaterAndFavorite() {
        ...
        when(store.getRecipe(Mockito.anyString())).thenReturn(recipe);
        when(favorites.toggle(Mockito.anyString())).thenReturn(true);
